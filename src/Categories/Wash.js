...
const Wash = (props) => {
  ...
  const showMessage = () => {
    Alert.alert(
      'Wash Only', 
      'Standard Delivery for Wash after 4 working days. Machine wash & tumble dry. Combined packaging. Preferred for Casual & Regular Wears.',
      [
  ...
  const [menItems, setmenitems] = React.useState([
    {
      ...
      price: 55, totalPrice: 0, count: 0, type: "Wash", category:"Men"
    },
    {
      title: "T-shirt",
  ...
  const [womenItems, setwomenitems] = React.useState([
    {
      title: "Shirt",
      image: require('../../assets/shirts.png'),
      price: 55, totalPrice: 0, count: 0, type: "Wash", category:"Women"
    },
    {
      title: "T-shirt",
      image: require('../../assets/tshirt.png'),
  ...
  const [houseHold, setHouseHold] = React.useState([
    {
      ...
      price: 55, totalPrice: 0, count: 0, type: "Wash", category: "Household"
    },
    {
      title: "Cushion Cover",
      image: require('../../assets/pillowCover.png'),
  ...
  const [kidsItems, setkidsItems] = React.useState([
    {
      title: "Shirt",
      image: require('../../assets/shirts.png'),
      price: 55, totalPrice: 0, count: 0, type: "Wash", category: "Kids"
    },
    {
      title: "T-shirt/Top",
      image: require('../../assets/tshirt.png'),
...
const navigates = () => {
  if((mencartItems.length + womencartItems.length + houseHoldcartItems.length + kidscartItems.length) == 0){
    alert("No item selected !");
      ...
      props.navigation.navigate('SelectAddress',{items:concatArray(),service:"Wash"})
  }
}
