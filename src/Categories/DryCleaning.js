...
const DryCleaning = (props) => {
  ...
  const showMessage = () => {
    Alert.alert(
      'Dry Cleaning', 
      'Standard Delivery for Dry Cleaning after 4 working days. Ecofriendly chemical cleaning, spot removal of stains, dry wash. Individual Packaging. Crisp Steam Ironing. Preferred for Expensive & Fancy Garments/Heavy items.',
      [
  ...
  const [menItems, setmenitems] = React.useState([
    {
      ...
      price: 55, totalPrice: 0, count: 0, type: "DryCleaning", category:"Men"
    },
    {
      title: "T-shirt",
  ...
  const [womenItems, setwomenitems] = React.useState([
    {
      title: "Shirt",
      image: require('../../assets/shirts.png'),
      price: 55, totalPrice: 0, count: 0, type: "DryCleaning", category:"Women"
    },
    {
      title: "T-shirt",
      image: require('../../assets/tshirt.png'),
  ...
  const [houseHold, setHouseHold] = React.useState([
    {
      ...
      price: 55, totalPrice: 0, count: 0, type: "DryCleaning", category: "Household"
    },
    {
      title: "Blanket/Quilt",
      image: require('../../assets/comforters.png'),
  ...
  const [kidsItems, setkidsItems] = React.useState([
    {
      title: "Shirt",
      image: require('../../assets/shirts.png'),
      price: 55, totalPrice: 0, count: 0, type: "DryCleaning", category: "Kids"
    },
    {
      title: "T-shirt/Top",
      image: require('../../assets/tshirt.png'),
...
const navigates = () => {
  if((mencartItems.length + womencartItems.length + houseHoldcartItems.length + kidscartItems.length) == 0){
    ...
    props.navigation.navigate('SelectAddress',{items:concatArray(),service:"Dry Cleaning"})
  }
} 
