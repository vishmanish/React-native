...
const PremiumWashIron = (props) => {
  ...
  const showMessage = () => {
    Alert.alert(
      'Premium Wash & Iron', 
      'Standard Delivery for Premium Wash after 4 working days. Soft & Gentle Wash with additional care. Steam Ironing. Individual Packaging. Cuff & Collar Cleaning. Preferred for Formals, Whites, Branded Clothes & other Expensive Garments.',
      [
  ...
  const [menItems, setmenitems] = React.useState([
    {
      ...
      price: 55, totalPrice: 0, count: 0, type: "PremiumWashIron", category:"Men"
    },
    {
      title: "T-shirt",
    ...
    },
    {
      ...
      image: require('../../assets/leatherJacket.png'),
      price: 55, totalPrice: 0, count: 0, type: "PremiumWashIron", category:"Men"
    },
    {
      title: "Cap",
    ...
    {
      title: "Sweater-half",
      image: require('../../assets/halfSweater.png'),
      price: 55, totalPrice: 0, count: 0, type: "PremiumWashIron", category:"Men"
    },
    {
      title: "Sweater-full",
      image: require('../../assets/fullSweater.png'),
      price: 55, totalPrice: 0, count: 0, type: "PremiumWashIron", category:"Men"
    },
    {
      title: "Shawl",
    ...
    {
      title: "Overcoat",
      image: require('../../assets/overcoat.png'),
      price: 55, totalPrice: 0, count: 0, type: "PremiumWashIron", category:"Men"
    },
    {
      title: "Pullover",
      image: require('../../assets/pullover.png'),
      price: 55, totalPrice: 0, count: 0, type: "PremiumWashIron", category:"Men"
    },
  ]);
  ...
  const [womenItems, setwomenitems] = React.useState([
    {
      title: "Shirt",
      image: require('../../assets/shirts.png'),
      price: 55, totalPrice: 0, count: 0, type: "PremiumWashIron", category:"Women"
    },
    {
      title: "T-shirt",
      image: require('../../assets/tshirt.png'),
    ...
    {
      title: "Polish-Saree Cotton",
      image: require('../../assets/sari.png'),
      price: 55, totalPrice: 0, count: 0, type: "PremiumWashIron", category:"Women"
    },
    {
      title: "Polish-Saree Silk",
      image: require('../../assets/sari.png'),
      price: 55, totalPrice: 0, count: 0, type: "PremiumWashIron", category:"Women"
    },
    {
      title: "Polish-Saree With Work/Jari",
      image: require('../../assets/sari.png'),
      price: 55, totalPrice: 0, count: 0, type: "PremiumWashIron", category:"Women"
    },
    {
    ...
    {
      title: "Cardigan",
      image: require('../../assets/cardigans.png'),
      price: 55, totalPrice: 0, count: 0, type: "PremiumWashIron", category:"Women"
    },
    {
      title: "Shawl",
  ...
  const [houseHold, setHouseHold] = React.useState([
    {
      ...
      price: 55, totalPrice: 0, count: 0, type: "PremiumWashIron", category: "Household"
    },
    {
      title: "Cushion Cover",
      image: require('../../assets/pillowCover.png'),
    ...
    {
      title: "Towel",
      image: require('../../assets/towel.png'),
      price: 55, totalPrice: 0, count: 0, type: "PremiumWashIron", category: "Household"
    },
    {
      title: "Bath Gown",
      image: require('../../assets/bathGown.png'),
      price: 55, totalPrice: 0, count: 0, type: "PremiumWashIron", category: "Household"
    },
    {
      title: "Comforter",
      image: require('../../assets/comforters.png'),
      price: 55, totalPrice: 0, count: 0, type: "PremiumWashIron", category: "Household"
    },
    {
      title: "Blanket/Quilt",
    ...
    {
      title: "Curtains",
      image: require('../../assets/curtans.png'),
      price: 55, totalPrice: 0, count: 0, type: "PremiumWashIron", category: "Household"
    },
  ]);
  ...
  const [kidsItems, setkidsItems] = React.useState([
    {
      title: "Shirt",
      image: require('../../assets/shirts.png'),
      price: 55, totalPrice: 0, count: 0, type: "PremiumWashIron", category: "Kids"
    },
    {
      title: "T-shirt/Top",
      image: require('../../assets/tshirt.png'),
...
const navigates = () => {
  if((mencartItems.length + womencartItems.length + houseHoldcartItems.length + kidscartItems.length) == 0){
    alert("No item selected !");
      ...
      props.navigation.navigate('SelectAddress',{items:concatArray(),service:"Premium Wash & Iron"})
  }
}  
...
export default PremiumWashIron;
