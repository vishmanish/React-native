...
const Pickup = (props) => {
      ...
      <View style={styles.innerboxesView}>
       <View style={{margin:1*vh}}>
        ...
        <TouchableOpacity 
          ...
          onPress={()=>alert('Your order is cancelled !')}>
  ...
  return (
    ...
    >
      ...
      <CardView orderID="BNG1827345" date="23 May , 08:28 PM" amount="500 (due)" status="Items not received" props={props}/>
       </View>
    </ScrollView>
  );
};
...
const styles = StyleSheet.create({
  ...
  titles:{color:Colors.black,padding:1*vw,textAlign:"left",fontFamily:"Muli-Bold",fontSize:2*vh},
